        ...
        <div class="form-group">
            <div>
                <label class="title-content-register" for="birth date">
                    <span class="icon"><img src="../images/icon-date.png" alt="Icono de Correo Electrónico"></span>
                    Birth Date:
                </label>
            </div>
            <div class="mt-4">
        ...
        <div class="form-group">
            <div>
                <label class="title-content-register" for="phone number">
                    <span class="icon"><img src="../images/phone-icon.png" alt="Icono de Correo Electrónico"></span>
                    Phone Number:
                </label>
            </div>
            <div class="mt-4">
        ...
        <div class="form-group">
            <div>
                <label class="title-content-register" for="email">
                    <span class="icon"><img src="../images/email-icon.png" alt="Icono de Correo Electrónico"></span>
                    Email:
                </label>
            </div>
            <div class="mt-4">
